            ...
            return {
                ...
                link: function (scope, element, attrs, ctrl) {
                    ...
                    ctrl.postTourCallback = function (completed) {
                        ...
                        backDrop = false;
                        angular.element('.tour-active-element').removeClass('tour-active-element');
        ...
        function ($window, $compile, $interpolate, $timeout, scrollTo, tourConfig, debounce, $log) {
            ...
            return {
                ...
                link: function (scope, element, attrs, tourCtrl) {
                    scope.backDrop = tourConfig.backDrop;
                    ...
                    //defaults: tourConfig.backDrop
                    attrs.$observe('tourBackdrop', function (val) {
                        scope.backDrop = !val ? tourConfig.backDrop : val === 'true';
                    });
                    ...
                    function show() {
                        ...
                        if (targetElement === null || targetElement.length === 0) {
                            ...
                            var updatePosition = function () {
                                if (scope.ttPlacement === 'centered') {
                                    tourtip.addClass('toortip-centered');
                            ...
                            toggleBackdrop(scope.backDrop, targetElement);
                    ...
                    function toggleBackdrop(enabled, targetElement) {
                        if (enabled) {
                            ...
                            angular.element('.tour-backdrop').remove();
                            angular.element('.tour-active-element').remove();
                        }
                    ...
                    function focusActiveElement(el) {
                        ...
                        var clone = angular.copy(el);
                        clone.addClass('tour-active-element');
                        clone.css('top', top);
                        clone.css('left', left);
                        angular.element(tourConfig.containerElement).append(clone);
                    }
