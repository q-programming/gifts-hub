...
<head>
    ...
    <title>Dodawanie konta dziecka do innej grupy</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <table class="main">
        ...
        <tr>
            ...
            <td>
                ...
                <div>
                    ${owner} chce doda&#263; dziecka ${kidName} do swojej grupy "${groupName}" w aplikacji Gifts Hub.<br>
                    Jako &#380;e jeste&#347; administratorem grupy, do kt&oacute;rej nale&#380;y konto dziecka, twoja zgoda jest wymagana (
                    lub innego administratora )
                </div>
