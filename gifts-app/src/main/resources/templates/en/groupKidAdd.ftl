...
<head>
    ...
    <title>Adding kid account to other group</title>
    <style>
        * {
            margin: 0;
            padding: 0;
    ...
    <table class="main">
        ...
        <tr>
            ...
            <td>
                ...
                <div>
                ${owner} wants to add kid account ${kidName} to his group "${groupName}" in Gifts Hub application<br>
                    As you are administrator of group in which kid account is, your permission is required ( or of any other admins )
                </div>
